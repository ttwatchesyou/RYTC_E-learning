...
export const electricalComponents: ComponentDefinition[] = [
  { id: "ac-power", type: "acPower", name: "AC Power Supply", shortName: "AC", category: "Supply", terminals: [{ id: "l", label: "L", kind: "power", position: "bottom" }, { id: "n", label: "N", kind: "power", position: "bottom" }], properties: { voltage: "400 VAC", phases: 3 }, defaultState: "READY", accent: "#38bdf8", icon: HiOutlineBolt },
  { id: "dc-power", type: "dcPower", name: "DC Power Supply", shortName: "DC", category: "Supply", terminals: [{ id: "pos", label: "+", kind: "control", position: "bottom" }, { id: "neg", label: "−", kind: "control", position: "bottom" }], properties: { voltage: "24 VDC" }, defaultState: "READY", accent: "#38bdf8", icon: HiOutlinePower },
  { id: "breaker", type: "breaker", name: "Circuit Breaker", shortName: "QF", category: "Protection", terminals: [{ id: "in", label: "1", kind: "power", position: "top" }, { id: "out", label: "2", kind: "power", position: "bottom" }], properties: { rating: "16 A", poles: 3 }, defaultState: "OFF", accent: "#f59e0b", icon: TbCircuitSwitchOpen },
  { id: "fuse", type: "fuse", name: "Fuse", shortName: "FU", category: "Protection", terminals: [{ id: "in", label: "1", kind: "power", position: "top" }, { id: "out", label: "2", kind: "power", position: "bottom" }], properties: { rating: "10 A" }, defaultState: "NORMAL", accent: "#f59e0b", icon: HiOutlineShieldCheck },
  { id: "contactor", type: "contactor", name: "Contactor", shortName: "KM", category: "Control", terminals: [{ id: "l1", label: "L1", kind: "power", position: "top" }, { id: "t1", label: "T1", kind: "power", position: "bottom" }, { id: "a1", label: "A1", kind: "control", position: "left" }, { id: "a2", label: "A2", kind: "control", position: "right" }], properties: { coil: "24 VDC", current: "12 A" }, defaultState: "OFF", accent: "#a78bfa", icon: TbCircuitAmmeter },
  { id: "overload", type: "overload", name: "Overload Relay", shortName: "OL", category: "Protection", terminals: [{ id: "in", label: "L1", kind: "power", position: "top" }, { id: "out", label: "T1", kind: "power", position: "bottom" }, { id: "95", label: "95", kind: "control", position: "left" }, { id: "96", label: "96", kind: "control", position: "right" }], properties: { range: "4–6 A" }, defaultState: "NORMAL", accent: "#f97316", icon: HiOutlineExclamationTriangle },
  { id: "relay", type: "relay", name: "Relay", shortName: "KA", category: "Control", terminals: [{ id: "a1", label: "A1", kind: "control", position: "top" }, { id: "a2", label: "A2", kind: "control", position: "bottom" }], properties: { coil: "24 VDC" }, defaultState: "OFF", accent: "#a78bfa", icon: LuGitBranch },
  { id: "start-button", type: "startButton", name: "Start Push Button", shortName: "START", category: "Control", terminals: [{ id: "13", label: "13", kind: "control", position: "top" }, { id: "14", label: "14", kind: "control", position: "bottom" }], properties: { contact: "NO" }, defaultState: "RELEASED", accent: "#22c55e", icon: HiOutlinePower },
  { id: "stop-button", type: "stopButton", name: "Stop Push Button", shortName: "STOP", category: "Control", terminals: [{ id: "21", label: "21", kind: "control", position: "top" }, { id: "22", label: "22", kind: "control", position: "bottom" }], properties: { contact: "NC" }, defaultState: "RELEASED", accent: "#ef4444", icon: HiOutlineStopCircle },
  { id: "emergency-stop", type: "emergencyStop", name: "Emergency Stop", shortName: "E-STOP", category: "Control", terminals: [{ id: "21", label: "21", kind: "control", position: "top" }, { id: "22", label: "22", kind: "control", position: "bottom" }], properties: { contact: "NC", locking: true }, defaultState: "RELEASED", accent: "#ef4444", icon: HiOutlineExclamationTriangle },
  { id: "selector", type: "selector", name: "Selector Switch", shortName: "SA", category: "Control", terminals: [{ id: "com", label: "COM", kind: "control", position: "top" }, { id: "out", label: "OUT", kind: "control", position: "bottom" }], properties: { positions: 2 }, defaultState: "AUTO", accent: "#eab308", icon: HiOutlineAdjustmentsHorizontal },
  { id: "limit-switch", type: "limitSwitch", name: "Limit Switch", shortName: "LS", category: "Control", terminals: [{ id: "com", label: "COM", kind: "signal", position: "top" }, { id: "no", label: "NO", kind: "signal", position: "bottom" }], properties: { contact: "1NO/1NC" }, defaultState: "OPEN", accent: "#14b8a6", icon: TbPlugConnected },
  { id: "motor", type: "motor", name: "Motor", shortName: "M", category: "Load", terminals: [{ id: "u", label: "U", kind: "power", position: "top" }, { id: "v", label: "V", kind: "power", position: "top" }, { id: "w", label: "W", kind: "power", position: "top" }], properties: { power: "2.2 kW", voltage: "400 VAC" }, defaultState: "STOPPED", accent: "#22c55e", icon: HiOutlineCircleStack },
  { id: "indicator", type: "indicator", name: "Indicator Lamp", shortName: "HL", category: "Load", terminals: [{ id: "x1", label: "X1", kind: "control", position: "top" }, { id: "x2", label: "X2", kind: "control", position: "bottom" }], properties: { color: "Green", voltage: "24 VDC" }, defaultState: "OFF", accent: "#84cc16", icon: HiOutlineLightBulb },
  { id: "sensor", type: "sensor", name: "Sensor", shortName: "B1", category: "Control", terminals: [{ id: "v", label: "+V", kind: "signal", position: "top" }, { id: "out", label: "OUT", kind: "signal", position: "bottom" }], properties: { kind: "Proximity", range: "8 mm" }, defaultState: "CLEAR", accent: "#06b6d4", icon: MdOutlineSensors },
  { id: "vfd", type: "vfd", name: "VFD", shortName: "VFD", category: "Drive", terminals: [{ id: "r", label: "R", kind: "power", position: "top" }, { id: "u", label: "U", kind: "power", position: "bottom" }, { id: "di1", label: "DI1", kind: "signal", position: "left" }], properties: { power: "2.2 kW", frequency: "0–50 Hz" }, defaultState: "READY", accent: "#8b5cf6", icon: LuGauge },
  { id: "terminal-block", type: "terminalBlock", name: "Terminal Block", shortName: "XT", category: "Utility", terminals: [{ id: "1", label: "1", kind: "power", position: "top" }, { id: "2", label: "2", kind: "power", position: "bottom" }], properties: { ways: 12 }, defaultState: "PASSIVE", accent: "#64748b", icon: MdOutlineElectricMeter },
];
